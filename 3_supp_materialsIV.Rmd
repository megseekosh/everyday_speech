---
title: "Supp. Materials IV for `Bursty, irregular speech input to children predicts vocabulary size'"
...
sleep_cds_model2 <- sleep_cds %>%
  ...
  filter(sleep_dur_mins>0) # remove all 0-minute naps 
```
